      ...
      <div class="manage-books">
        ...
        <div class="table">
          <div class="table-header">
            <div class="header__item">Issue_Id</div>
            <div class="header__item">ISBN</div>
            <div class="header__item">reader_Id</div>
            <div class="header__item">Approver_ID</div>
            ...
            <div class="header__item">return Approver_Id</div>
